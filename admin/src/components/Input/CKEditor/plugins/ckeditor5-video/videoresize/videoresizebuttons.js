...
const { Plugin, icons } = window.CKEditor5.core;
const { ButtonView, DropdownButtonView, ViewModel: Model, createDropdown, addListToDropdown } = window.CKEditor5.ui;
const { CKEditorError, Collection } = window.CKEditor5.utils;
