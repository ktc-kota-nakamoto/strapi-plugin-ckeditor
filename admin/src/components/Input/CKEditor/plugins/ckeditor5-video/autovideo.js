...
const { Clipboard } = window.CKEditor5.clipboard;
const { LivePosition, LiveRange } = window.CKEditor5.engine;
const { Undo } = window.CKEditor5.undo;
const { global } = window.CKEditor5.utils;
